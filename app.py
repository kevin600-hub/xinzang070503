...
st.set_page_config(page_title="🫀 心脏病风险预测系统", layout="centered")
st.title("💓 心脏病预测系统")
...
def user_input():
    ...
    ca = st.sidebar.slider("主要血管数量 (0-3)", 0, 3, 0)
...
try:
    ...
    st.metric("模型预测概率", f"{proba*100:.2f}%")
